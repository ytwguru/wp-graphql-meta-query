    ...
    public function map_input_fields( $query_args, $input_args ) {
        ...
        if ( ! empty( $input_args['metaQuery'] ) ) {
            ...
            if(isset($query_args['meta_query']))
                $query_args['meta_query'] = array_merge($query_args['meta_query'], $meta_query['metaArray']);
            else
                $query_args['meta_query'] =$meta_query['metaArray'];
            $query_args['meta_query']['relation'] = $meta_query['relation'];
